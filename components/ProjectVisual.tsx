...
const visuals: Record<string, Visual> = {
  ...
  'dopoki-zycie-trwa': {
    bd: { background: 'repeating-linear-gradient(45deg,rgba(255,255,255,.09) 0 1px,transparent 1px 15px)' },
    kind: 'diamond',
  },
  'daily-word': {
    bd: { background: 'repeating-linear-gradient(0deg,rgba(255,255,255,.09) 0 1px,transparent 1px 14px)' },
    kind: 'square',
  },
  'aura-season': {
    bd: { background: 'repeating-radial-gradient(circle at 50% 50%,rgba(255,255,255,.12) 0 1px,transparent 1px 17px)' },
    kind: 'dot',
  },
  'lemmi-studio': {
    bd: {
      background:
        'repeating-linear-gradient(45deg,rgba(255,255,255,.07) 0 1px,transparent 1px 13px),repeating-linear-gradient(-45deg,rgba(255,255,255,.07) 0 1px,transparent 1px 13px)',
    },
    kind: 'diamond',
  },
  'luma-breathwork': {
  ...
  'feeling-journal': {
    bd: { background: 'repeating-linear-gradient(90deg,rgba(255,255,255,.09) 0 1px,transparent 1px 15px)' },
    kind: 'circle',
  },
  'calm-now': {
    bd: { background: 'radial-gradient(circle at 50% 45%,rgba(255,255,255,.12),transparent 62%)' },
    kind: 'circle',
  },
}
...
const fallback: Visual = {
  bd: {
    backgroundImage: 'radial-gradient(rgba(255,255,255,.12) 1.1px,transparent 1.3px)',
    backgroundSize: '15px 15px',
  },
  kind: 'circle',
}
